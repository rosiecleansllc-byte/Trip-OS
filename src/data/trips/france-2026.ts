...
export const franceTrip: Trip = {
  ...
  days: [
    {
      ...
      scheduleItems: [
        ...
        { id: 'd1-4', time: '19:30', label: 'Dinner: Le Procope', type: 'meal', location: 'Le Procope, Paris', websiteUrl: 'https://www.procope.com/en/', reservationUrl: 'https://www.procope.com/en/o/reserver/', tip: 'Your first-night Paris dinner — the later time gives you margin after the flight.', privateDocumentUrl: '/images/private-documents/france-2026/le-procope-qr-ticket.webp', privateDocumentLabel: 'View ticket' },
      ],
      outfitBoardId: 'ob1',
    },
    {
    ...
    },
    {
      ...
      scheduleItems: [
        ...
        { id: 'd4-6', time: '19:30', label: 'Dinner: Joséphine Chez Dumonet', type: 'meal', location: 'Joséphine Chez Dumonet, Paris', websiteUrl: 'https://www.josephinechezdumonet.fr/', phone: '+33 1 45 48 52 40', notes: '€75 card hold — decision deadline is 4:00 PM Paris time today. Reminder is already scheduled so you can cancel if Versailles runs long.', privateDocumentUrl: '/images/private-documents/france-2026/josephine-chez-dumonet-qr-ticket.webp', privateDocumentLabel: 'View ticket' },
      ],
    ...
    },
    {
      ...
      scheduleItems: [
        ...
        { id: 'd5-6', time: '16:30', label: 'Dinner: Le Campanella', type: 'meal', location: 'Le Campanella, 18 Avenue Bosquet, Paris', notes: 'Chosen over Le Suffren for the atmosphere.', privateDocumentUrl: '/images/private-documents/france-2026/le-campanella-qr-ticket.webp', privateDocumentLabel: 'View ticket' },
  ...
  bookings: [
    ...
    },
    {
      ...
      privateDocumentUrl: '/images/private-documents/france-2026/le-procope-qr-ticket.webp',
    ...
    },
    {
      ...
      privateDocumentUrl: '/images/private-documents/france-2026/josephine-chez-dumonet-qr-ticket.webp',
      privateDocumentLabel: 'View ticket',
    ...
    },
    {
      ...
      privateDocumentUrl: '/images/private-documents/france-2026/le-campanella-qr-ticket.webp',
      privateDocumentLabel: 'View ticket',
    },
    {
  ...
  outfitBoards: [
    ...
    { id: 'ob7', dayId: 'd7', imageUrl: '/images/outfits/day-07.webp', itemNames: ['Cream Textured Top', 'Dark Jeans', 'Navy Tommy Hilfiger Trench Coat', "Red Rothy's Flats", 'Black Crossbody Bag'], note: 'Simple and polished for travel and arrival in Paris.' },
