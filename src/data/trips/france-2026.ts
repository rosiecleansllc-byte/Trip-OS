...
export const franceTrip: Trip = {
  ...
  days: [
    {
      ...
      outfitNote: 'Striped knit + cuffed jeans + white sneakers + black quilted bag. Add the blue trench if cool or wet.',
    ...
    },
    {
      ...
      outfitNote: 'Day: white button-down + cuffed jeans + gold Cole Haan Mary Janes + black quilted bag. Evening Sainte-Chapelle concert: burgundy dress + black cropped top + burgundy patent pointed flats + black quilted bag.',
      scheduleItems: [
        ...
        { id: 'd2-4', time: '18:00', label: 'Dinner: Les Deux Palais', type: 'meal', location: 'Les Deux Palais, 3 Boulevard du Palais, Paris', phone: '+33 1 43 54 20 86', tip: 'Directly across from Sainte-Chapelle — that’s why the timing works so well.', privateDocumentKey: 'les-deux-palais-reservation', privateDocumentType: 'reservation' },
        { id: 'd2-5', time: '19:10', label: 'Head across for security', type: 'transport' },
        { id: 'd2-6', time: '20:00', label: 'Sainte-Chapelle classical concert', type: 'activity', location: 'Sainte-Chapelle, Paris', ticketUrl: 'https://www.classictic.com/en/city/paris-t7/concerts-at-la-sainte-chapelle/10055/', tip: 'One of your most elegant, least stressful days.', privateDocumentKey: 'sainte-chapelle-confirmation', privateDocumentType: 'confirmation' },
      ],
      outfitBoardId: 'ob2',
    },
    {
      ...
      outfitNote: 'Hunter green pleated blouse + black trousers + black/gold belt + burgundy patent pointed flats + black quilted bag. Navy blazer optional.',
      scheduleItems: [
    ...
    },
    {
      ...
      outfitNote: 'Burgundy knit over white button-down + striped knit draped over shoulders + cuffed jeans + white sneakers. Add the blue trench if needed.',
      scheduleItems: [
    ...
    },
    {
      ...
      outfitNote: 'Black cropped top layered over white button-down + cuffed jeans + white sneakers + black quilted bag.',
      scheduleItems: [
    ...
    },
    {
      ...
      outfitNote: 'Cream/white knit + beige cardigan + cuffed jeans + white sneakers + black quilted bag. Blue trench or white rain shell for wind/rain.',
    ...
    },
    {
      ...
      outfitNote: 'Striped knit + black trousers + white sneakers + black quilted bag. Blue trench for the drive back to Paris.',
      scheduleItems: [
    ...
    },
    {
      ...
      legId: 'riviera',
      title: 'Paris → Nice',
      outfitNote: 'White tee knit + cuffed jeans + beige cardigan + white sneakers + black quilted bag for the Paris-to-Nice train and arrival.',
    ...
    },
    {
      ...
      legId: 'riviera',
      title: 'Èze + Menton',
      outfitNote: 'White button-down + cuffed jeans + silk scarf + white sneakers + black quilted bag for Èze and Menton.',
      scheduleItems: [
    ...
    },
    {
      ...
      outfitNote: 'Navy fitted dress + gold Cole Haan Mary Janes + black quilted bag. Beige cardigan or navy blazer if cool.',
      scheduleItems: [
    ...
    },
    {
      ...
      outfitNote: 'Striped knit + black trousers + blue trench + white sneakers + black quilted bag for Nice-to-Paris travel.',
      scheduleItems: [
    ...
    },
    {
      ...
      legId: 'departure',
      title: 'Fly home',
      outfitNote: 'White tee knit + cuffed jeans + beige cardigan + white sneakers + black quilted bag for the flight home.',
      scheduleItems: [
  ...
  bookings: [
    ...
    },
    {
      ...
      privateDocumentKey: 'le-procope-ticket',
    ...
    },
    {
      ...
      privateDocumentKey: 'les-deux-palais-reservation',
      privateDocumentType: 'reservation',
    },
    {
      ...
      privateDocumentKey: 'sainte-chapelle-confirmation',
      privateDocumentType: 'confirmation',
    },
    {
      id: 'bk-ticket-dior',
    ...
    },
    {
      ...
      privateDocumentKey: 'josephine-dumonet-ticket',
      privateDocumentType: 'ticket',
    ...
    },
    {
      ...
      privateDocumentKey: 'le-campanella-ticket',
      privateDocumentType: 'ticket',
    },
    {
      ...
      privateDocumentKey: 'seine-cruise-ticket',
      privateDocumentType: 'ticket',
    },
    {
  ...
  transport: [
    ...
    },
    {
      ...
      privateDocumentKey: 'sixt-rental-car-confirmation',
      privateDocumentType: 'confirmation',
    },
    {
    ...
    },
    {
      ...
      privateDocumentKey: 'sncf-paris-nice-confirmation',
      privateDocumentType: 'confirmation',
    },
    {
      id: 'tr-bus-eze',
  ...
  capsule: [
    { id: 'c1', category: 'outerwear', name: 'Blue Trench Coat', imageUrl: '/images/capsule/c1.webp' },
    { id: 'c19', category: 'outerwear', name: 'Navy Blazer', imageUrl: '/images/capsule/c19.webp' },
    { id: 'c2', category: 'top', name: 'White Button-Down', imageUrl: '/images/capsule/c2.webp' },
    { id: 'c3', category: 'top', name: 'White Tee Knit', imageUrl: '/images/capsule/c3.webp' },
    { id: 'c5', category: 'top', name: 'Cream/Navy Striped Knit', imageUrl: '/images/capsule/c5.webp' },
    { id: 'c20', category: 'top', name: 'Burgundy Knit' },
    { id: 'c21', category: 'top', name: 'Black Cropped Top', note: 'Same piece styled either loose or tucked.' },
    { id: 'c22', category: 'top', name: 'Hunter Green Pleated Blouse' },
    { id: 'c11', category: 'top', name: 'Beige Cardigan', imageUrl: '/images/capsule/c11.webp' },
    { id: 'c7', category: 'bottom', name: 'Cuffed Jeans', imageUrl: '/images/capsule/c7.webp' },
    { id: 'c8', category: 'bottom', name: 'Black Trousers', imageUrl: '/images/capsule/c8.webp' },
    { id: 'c23', category: 'dress', name: 'Burgundy Dress' },
    { id: 'c24', category: 'dress', name: 'Navy Fitted Dress' },
    { id: 'c12', category: 'outerwear', name: 'White Rain Shell' },
    { id: 'c13', category: 'outerwear', name: 'Banana Republic Capelet' },
    ...
    { id: 'c25', category: 'shoes', name: 'Burgundy Patent Pointed Flats', note: 'Pointed patent flats with ankle strap, bow and gold hardware.' },
    { id: 'c17', category: 'accessory', name: 'Black Quilted Bag', imageUrl: '/images/capsule/c17.webp' },
    { id: 'c18', category: 'accessory', name: 'Silk Scarf', imageUrl: '/images/capsule/c18.webp' },
    { id: 'c26', category: 'accessory', name: 'Black/Gold Belt' },
    { id: 'c27', category: 'accessory', name: 'Sunglasses' },
  ],

  outfitBoards: [
    { id: 'ob1', dayId: 'd1', imageUrl: '/images/outfits/day-01.webp', itemNames: ['Cream/Navy Striped Knit', 'Cuffed Jeans', 'White Sneakers', 'Black Quilted Bag', 'Blue Trench Coat'], note: 'Travel-day comfort with a polished Paris finish.' },
    { id: 'ob2', dayId: 'd2', imageUrl: '/images/outfits/day-02.webp', itemNames: ['White Button-Down', 'Cuffed Jeans', 'Gold Cole Haan Mary Janes', 'Black Quilted Bag', 'Burgundy Dress', 'Black Cropped Top', 'Burgundy Patent Pointed Flats'], note: 'Day-to-evening plan: relaxed Saint-Germain by day, then the burgundy concert look for Sainte-Chapelle.' },
    { id: 'ob3', dayId: 'd3', imageUrl: '/images/outfits/day-03.webp', itemNames: ['Hunter Green Pleated Blouse', 'Black Trousers', 'Black/Gold Belt', 'Burgundy Patent Pointed Flats', 'Black Quilted Bag', 'Navy Blazer'], note: 'Galerie Dior: modern, polished and fashion-forward.' },
    { id: 'ob4', dayId: 'd4', imageUrl: '/images/outfits/day-04.webp', itemNames: ['Burgundy Knit', 'White Button-Down', 'Cream/Navy Striped Knit', 'Cuffed Jeans', 'White Sneakers', 'Blue Trench Coat'], note: 'Versailles: layered, comfortable and distinct from the Dior look.' },
    { id: 'ob5', dayId: 'd5', imageUrl: '/images/outfits/day-05.webp', itemNames: ['Black Cropped Top', 'White Button-Down', 'Cuffed Jeans', 'White Sneakers', 'Black Quilted Bag'], note: 'Louvre, Tuileries and Seine: clean city layers built for a full walking day.' },
    { id: 'ob6', dayId: 'd6', imageUrl: '/images/outfits/day-06.webp', itemNames: ['White Tee Knit', 'Beige Cardigan', 'Cuffed Jeans', 'White Sneakers', 'Black Quilted Bag', 'Blue Trench Coat', 'White Rain Shell'], note: 'Mont-Saint-Michel: practical layers with weather protection.' },
    { id: 'ob7', dayId: 'd7', imageUrl: '/images/outfits/day-07.webp', itemNames: ['Cream/Navy Striped Knit', 'Black Trousers', 'White Sneakers', 'Black Quilted Bag', 'Blue Trench Coat'], note: 'Mont-Saint-Michel to Paris: comfortable for the drive and polished on arrival.' },
    { id: 'ob8', dayId: 'd8', imageUrl: '/images/outfits/day-08.webp', itemNames: ['White Tee Knit', 'Cuffed Jeans', 'Beige Cardigan', 'White Sneakers', 'Black Quilted Bag'], note: 'Paris to Nice: easy train-day layers that work for an Old Nice stroll on arrival.' },
    { id: 'ob9', dayId: 'd9', imageUrl: '/images/outfits/day-09.webp', itemNames: ['White Button-Down', 'Cuffed Jeans', 'Silk Scarf', 'White Sneakers', 'Black Quilted Bag'], note: 'Èze + Menton: Riviera polish with walking-friendly shoes.' },
    { id: 'ob10', dayId: 'd10', imageUrl: '/images/outfits/day-10.webp', itemNames: ['Navy Fitted Dress', 'Gold Cole Haan Mary Janes', 'Black Quilted Bag', 'Beige Cardigan', 'Navy Blazer'], note: 'Nice + Villefranche-sur-Mer: relaxed seaside elegance.' },
    { id: 'ob11', dayId: 'd11', imageUrl: '/images/outfits/day-11.webp', itemNames: ['Cream/Navy Striped Knit', 'Black Trousers', 'Blue Trench Coat', 'White Sneakers', 'Black Quilted Bag'], note: 'Nice to Paris/CDG: streamlined and travel-ready.' },
